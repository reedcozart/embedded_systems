...
void Timer0A_SongTimer(void){
  ...
  TIMER0_TAILR_R = 12000000;         // start value for 100 Hz interrupts
...
void Timer1_N1_Init(void){   //This is the alarm timer!
...
void Timer2_N2_Init(void){ //this is the seconds counter
...
void Timer3_N3_Init(void){ //this is the seconds counter
  ...
  TIMER3_TAILR_R = 80000000;      // 4) reload value - 1Hz intervals
